                    ...
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                        {compVar.map((item, i) => (
                            <div id='cardHero' className="w-100 h-100 col-3" key={i}>
                                <a className="card d-flex prime" type='button' href={`${item.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'absolute' }}>
                                        <Img src={item.src} alt={item.title} style={{ width: '250px', height: '250px' }}/>
                                    </div>
