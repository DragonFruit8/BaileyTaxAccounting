                    ...
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <img src='/src/assets/image/ind.jpg' alt={compVar[].title} style={{ position: 'relative', width: '100%', height: '100%', backgroundPosition: 'cover' }} />
                                    </div>
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <img src='/src/assets/image/biz.jpg' alt={compVar.title} style={{ position: 'relative', width: '100%', height: '100%', backgroundPosition: 'cover' }} />
                                    </div>
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h5 className="card-title text-white m-0">{compVar.title}</h5>
                                    </div>
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                    <img src='/src/assets/image/corp.jpg' alt={compVar.title} style={{ position: 'relative', width: '100%', height: '100%', backgroundPosition: 'cover' }} />
                                    </div>
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h5 className="card-title text-white m-0">{compVar.title}</h5>
                                    </div>
                                ...
                                <ul className="list-group list-group-flush">
                                    ...
                                    {resources.map((resource, i) => (
                                        <li key={i} className="list-group-item lead">
                                            <a to={{ pathname: `${owner.calender}` }} target='_blank'>{resource.title}</a>
                                        </li>
                                    ))}
                                </ul>
