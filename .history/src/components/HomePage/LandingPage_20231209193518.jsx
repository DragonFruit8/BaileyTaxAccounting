                ...
                <span className='container-xl'>
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a id='individual' className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" >
                                    
                                    </div>
                                    <div className="card-body shadow-lg rounded-bottom" style={{ position: 'absolute', bottom: '0', height: '100px', backgroundColor: '#90480E', zIndex: '1000' }}>
                                        <h5 className="card-title text-white m-0">{compVar.title}</h5>
                                    </div>
                                </a>
                            </div>
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a id='smallBiz' className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" >
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a id='corporate' className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
