    ...
    const compVar = [
        {
            id: 1,
            type: 'individual',
            src: '/assets/radu - florin - CwTBt6jyagQ - unsplash.jpg',
            title: 'Individual',
        ...
        },
        {
            id: 2,
            type: "smallBiz",
            src: '/assets/hunters-race-MYbhN8KaaEc-unsplash.jpg',
                                ...
                                <a className="card d-flex prime" type='button' href={`${calendly.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                        <img id='coverImage' src={
                                            calendly.type === 'individual' ? individual :
                                                calendly.type === 'smallBiz' ? smallBiz :
                                                    corporate
                                        } className='img-fluid' alt={calendly.title} style={
