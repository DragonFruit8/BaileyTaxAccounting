            ...
            <main className='text-white'>
                ...
                <span className='container-xl'>
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                            ...
                            <a className="card d-flex prime" type='button' href={`${compVar[0].bookNow}`} target={'_blank'} rel="noreferrer">
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                            <a className="card d-flex prime" type='button' href={`${compVar[0].bookNow}`} target={'_blank'}>
