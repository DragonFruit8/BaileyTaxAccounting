    ...
    const compVar = [
        {
            id: 1,
            type: 'individual',
            src: '/assets/image/"radu - florin - CwTBt6jyagQ - unsplash.jpg"',
            title: 'Individual',
        ...
        },
        {
            id: 2,
            type: "smallBiz",
            src: '/assets/image/hunters-race-MYbhN8KaaEc-unsplash.jpg',
        ...
        },
        {
            id: 3,
            type: "corporate",
            src: '/assets/image/scott-graham-5fNmWej4tAA-unsplash.jpg',
            title: 'Corporate',
            ...
            <main className='text-white'>
                ...
                <span className='container-xl'>
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                        {compVar.map((calendly, i) => (
                            <div id='cardHero' className="w-100 h-100 col-3" key={i}>
                                <a className="card d-flex prime" type='button' href={`${calendly.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                        <img id='coverImage' src={`${calendly[0].src[i]}`} className='img-fluid' alt={calendly.title} style={
                                            { position: 'absolute', minHeight: '250px', width: '250px', objectFit: 'cover' }
                                        } />
                                    </div>
