    ...
    const compVar = [
        {
            id: 1,
            type: 'individual',
            src: 'https://unsplash.com/photos/silhouette-photo-of-man-on-cliff-during-sunset-_6HzPU9Hyfg',
            title: 'Individual',
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3" key={i}>
                                <a className="card d-flex prime" type='button' href={`${calendly.bookNow}`}>
                                    <div id='cardOption' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                        <img src={'..//assets/image/' + calendly.src} alt={calendly.title} className="" style={{display: 'block',width: '100%', height: '100%',}} />
                                    </div>
