...
import individual from 'image/ind.jpg';
import smallBiz from '/assets/image/biz.jpg';
import corporate from 'image/corp.jpg';
                    ...
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOptionInd' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative', display: 'flex' }}>
                                    <img src={individual} alt={compVar.title} />
                                    </div>
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOptionBiz' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                    <img src={smallBiz} alt={compVar.title} style={{ position: 'absolute', width: '250px', height: '250px' }}/>
                                    </div>
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h5 className="card-title text-white m-0">{compVar.title}</h5>
                                    </div>
                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    <div id='cardOptionCorp' className="card-img-top shadow-lg rounded-bottom" style={{ position: 'relative' }}>
                                    <img src={corporate} alt={compVar.title} style={{ position: 'absolute', width: '100%', height: '250px', backgroundSize: 'cover' }}/>
                                    </div>
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h5 className="card-title text-white m-0">{compVar.title}</h5>
                                    </div>
