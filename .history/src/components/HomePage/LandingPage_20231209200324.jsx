                            ...
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h3 className="card-title text-white m-0">{compVar[0].title}</h3>
                                    </div>
                                </a>
                            </div>
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h3 className="card-title text-white m-0">{compVar[1].title}</h3>
                                    </div>
                                </a>
                            </div>
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <div className="card-body shadow-lg rounded-bottom" style={{ backgroundColor: '#90480E' }}>
                                        <h3 className="card-title text-white m-0">{compVar[2].title}</h3>
                                    </div>
                                </a>
                            </div>                     
                    </div>
