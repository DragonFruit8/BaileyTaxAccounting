                    ...
                    <div id='bizGroup' className="row d-flex justify-content-evenly">
                            <div id='cardHero' className="w-100 h-100 col-3">
                                <a className="card d-flex prime" type='button' href={`${compVar.bookNow}`}>
                                    ...
                                    <Image src='../../assets/image/radu-florin-CwTBt6jyagQ-unsplash.jpg' alt={compVar.title} />
                                    </div>
                        ...
                        <div id="cardHero" className="w-100 h-100 col-3">
                            <img src="./assets/image/radu-florin-CwTBt6jyagQ-unsplash.jpg" className="card-img-top" alt="" style={{
                                display: 'block',
                                width: '100%',
                                height: '100%',
